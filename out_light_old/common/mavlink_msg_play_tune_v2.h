...
/**
 * @brief Pack a play_tune_v2 message into a transmit buffer
 ...
 */
static inline uint16_t mavlink_msg_play_tune_v2_pack_txbuf(char* mav_txbuf, mavlink_status_t* mav_status, uint8_t system_id, uint8_t component_id,
                                   uint8_t target_system, uint8_t target_component, uint32_t format, const char *tune)
{
...
#else
    mavlink_play_tune_v2_t* packet = (mavlink_play_tune_v2_t*)(&mav_txbuf[header_len]);
    ...
    return mavlink_finalize_message_txbuf(mav_txbuf, mav_status, system_id, component_id,
                                          MAVLINK_MSG_ID_PLAY_TUNE_V2, MAVLINK_MSG_ID_PLAY_TUNE_V2_MIN_LEN, MAVLINK_MSG_ID_PLAY_TUNE_V2_LEN, MAVLINK_MSG_ID_PLAY_TUNE_V2_CRC);
}
