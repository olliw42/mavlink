 ...
 */
static inline uint16_t mavlink_msg_led_control_pack_txbuf(char* mav_txbuf, mavlink_status_t* mav_status, uint8_t system_id, uint8_t component_id,
...
#else
    mavlink_led_control_t* packet = (mavlink_led_control_t*)(&mav_txbuf[header_len]);
