...
//OW
/**
 * @brief Pack a uavionix_adsb_out_cfg message into a transmit buffer
 ...
 */
static inline uint16_t mavlink_msg_uavionix_adsb_out_cfg_pack_txbuf(char* mav_txbuf, mavlink_status_t* mav_status, uint8_t system_id, uint8_t component_id,
                                   uint32_t ICAO, const char *callsign, uint8_t emitterType, uint8_t aircraftSize, uint8_t gpsOffsetLat, uint8_t gpsOffsetLon, uint16_t stallSpeed, uint8_t rfSelect)
{
...
#else
    mavlink_uavionix_adsb_out_cfg_t* packet = (mavlink_uavionix_adsb_out_cfg_t*)(&mav_txbuf[header_len]);
    packet->ICAO = ICAO;
    ...
    return mavlink_finalize_message_txbuf(mav_txbuf, mav_status, system_id, component_id,
                                          MAVLINK_MSG_ID_UAVIONIX_ADSB_OUT_CFG, MAVLINK_MSG_ID_UAVIONIX_ADSB_OUT_CFG_MIN_LEN, MAVLINK_MSG_ID_UAVIONIX_ADSB_OUT_CFG_LEN, MAVLINK_MSG_ID_UAVIONIX_ADSB_OUT_CFG_CRC);
}
//OWEND
