...
//OW
/**
 * @brief Pack a change_operator_control_ack message into a transmit buffer
 ...
 */
static inline uint16_t mavlink_msg_change_operator_control_ack_pack_txbuf(char* mav_txbuf, mavlink_status_t* mav_status, uint8_t system_id, uint8_t component_id,
                                   uint8_t gcs_system_id, uint8_t control_request, uint8_t ack)
{
...
#else
    mavlink_change_operator_control_ack_t* packet = (mavlink_change_operator_control_ack_t*)(&mav_txbuf[header_len]);
    ...
    return mavlink_finalize_message_txbuf(mav_txbuf, mav_status, system_id, component_id,
                                          MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK, MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_MIN_LEN, MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_LEN, MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_CRC);
}
//OWEND
