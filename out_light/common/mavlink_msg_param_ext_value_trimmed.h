...
//OW
/**
 * @brief Pack a param_ext_value_trimmed message into a transmit buffer
 ...
 */
static inline uint16_t mavlink_msg_param_ext_value_trimmed_pack_txbuf(char* mav_txbuf, mavlink_status_t* mav_status, uint8_t system_id, uint8_t component_id,
                                   uint16_t param_count, uint16_t param_index, uint8_t param_type, const char *param_id, const char *param_value)
{
...
#else
    mavlink_param_ext_value_trimmed_t* packet = (mavlink_param_ext_value_trimmed_t*)(&mav_txbuf[header_len]);
    ...
    return mavlink_finalize_message_txbuf(mav_txbuf, mav_status, system_id, component_id,
                                          MAVLINK_MSG_ID_PARAM_EXT_VALUE_TRIMMED, MAVLINK_MSG_ID_PARAM_EXT_VALUE_TRIMMED_MIN_LEN, MAVLINK_MSG_ID_PARAM_EXT_VALUE_TRIMMED_LEN, MAVLINK_MSG_ID_PARAM_EXT_VALUE_TRIMMED_CRC);
}
//OWEND
