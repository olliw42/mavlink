...
//OW
/**
 * @brief Pack a autopilot_state_for_gimbal_device message into a transmit buffer
 ...
 */
static inline uint16_t mavlink_msg_autopilot_state_for_gimbal_device_pack_txbuf(char* mav_txbuf, mavlink_status_t* mav_status, uint8_t system_id, uint8_t component_id,
                                   uint64_t time_boot_us, uint8_t target_system, uint8_t target_component, const float *q, uint32_t q_estimated_delay_us, float vx, float vy, float vz, uint32_t v_estimated_delay_us, float feed_forward_angular_velocity_z)
{
...
#else
    mavlink_autopilot_state_for_gimbal_device_t* packet = (mavlink_autopilot_state_for_gimbal_device_t*)(&mav_txbuf[header_len]);
    ...
    return mavlink_finalize_message_txbuf(mav_txbuf, mav_status, system_id, component_id,
                                          MAVLINK_MSG_ID_AUTOPILOT_STATE_FOR_GIMBAL_DEVICE, MAVLINK_MSG_ID_AUTOPILOT_STATE_FOR_GIMBAL_DEVICE_MIN_LEN, MAVLINK_MSG_ID_AUTOPILOT_STATE_FOR_GIMBAL_DEVICE_LEN, MAVLINK_MSG_ID_AUTOPILOT_STATE_FOR_GIMBAL_DEVICE_CRC);
}
//OWEND
