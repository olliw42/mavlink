...
//OW
/**
 * @brief Pack a osd_param_show_config message into a transmit buffer
 ...
 */
static inline uint16_t mavlink_msg_osd_param_show_config_pack_txbuf(char* mav_txbuf, mavlink_status_t* mav_status, uint8_t system_id, uint8_t component_id,
                                   uint8_t target_system, uint8_t target_component, uint32_t request_id, uint8_t osd_screen, uint8_t osd_index)
{
...
#else
    mavlink_osd_param_show_config_t* packet = (mavlink_osd_param_show_config_t*)(&mav_txbuf[header_len]);
    ...
    return mavlink_finalize_message_txbuf(mav_txbuf, mav_status, system_id, component_id,
                                          MAVLINK_MSG_ID_OSD_PARAM_SHOW_CONFIG, MAVLINK_MSG_ID_OSD_PARAM_SHOW_CONFIG_MIN_LEN, MAVLINK_MSG_ID_OSD_PARAM_SHOW_CONFIG_LEN, MAVLINK_MSG_ID_OSD_PARAM_SHOW_CONFIG_CRC);
}
//OWEND
