...
//OW
/**
 * @brief Pack a hwstatus message into a transmit buffer
 ...
 */
static inline uint16_t mavlink_msg_hwstatus_pack_txbuf(char* mav_txbuf, mavlink_status_t* mav_status, uint8_t system_id, uint8_t component_id,
                                   uint16_t Vcc, uint8_t I2Cerr)
{
...
#else
    mavlink_hwstatus_t* packet = (mavlink_hwstatus_t*)(&mav_txbuf[header_len]);
    packet->Vcc = Vcc;
    ...
    return mavlink_finalize_message_txbuf(mav_txbuf, mav_status, system_id, component_id,
                                          MAVLINK_MSG_ID_HWSTATUS, MAVLINK_MSG_ID_HWSTATUS_MIN_LEN, MAVLINK_MSG_ID_HWSTATUS_LEN, MAVLINK_MSG_ID_HWSTATUS_CRC);
}
//OWEND
