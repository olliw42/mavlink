...
//OW
/**
 * @brief Pack a osd_param_show_config_reply message into a transmit buffer
 ...
 */
static inline uint16_t mavlink_msg_osd_param_show_config_reply_pack_txbuf(char* mav_txbuf, mavlink_status_t* mav_status, uint8_t system_id, uint8_t component_id,
                                   uint32_t request_id, uint8_t result, const char *param_id, uint8_t config_type, float min_value, float max_value, float increment)
{
...
#else
    mavlink_osd_param_show_config_reply_t* packet = (mavlink_osd_param_show_config_reply_t*)(&mav_txbuf[header_len]);
    ...
    return mavlink_finalize_message_txbuf(mav_txbuf, mav_status, system_id, component_id,
                                          MAVLINK_MSG_ID_OSD_PARAM_SHOW_CONFIG_REPLY, MAVLINK_MSG_ID_OSD_PARAM_SHOW_CONFIG_REPLY_MIN_LEN, MAVLINK_MSG_ID_OSD_PARAM_SHOW_CONFIG_REPLY_LEN, MAVLINK_MSG_ID_OSD_PARAM_SHOW_CONFIG_REPLY_CRC);
}
//OWEND
