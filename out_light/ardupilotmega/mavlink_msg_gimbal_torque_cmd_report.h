...
//OW
/**
 * @brief Pack a gimbal_torque_cmd_report message into a transmit buffer
 ...
 */
static inline uint16_t mavlink_msg_gimbal_torque_cmd_report_pack_txbuf(char* mav_txbuf, mavlink_status_t* mav_status, uint8_t system_id, uint8_t component_id,
                                   uint8_t target_system, uint8_t target_component, int16_t rl_torque_cmd, int16_t el_torque_cmd, int16_t az_torque_cmd)
{
...
#else
    mavlink_gimbal_torque_cmd_report_t* packet = (mavlink_gimbal_torque_cmd_report_t*)(&mav_txbuf[header_len]);
    ...
    return mavlink_finalize_message_txbuf(mav_txbuf, mav_status, system_id, component_id,
                                          MAVLINK_MSG_ID_GIMBAL_TORQUE_CMD_REPORT, MAVLINK_MSG_ID_GIMBAL_TORQUE_CMD_REPORT_MIN_LEN, MAVLINK_MSG_ID_GIMBAL_TORQUE_CMD_REPORT_LEN, MAVLINK_MSG_ID_GIMBAL_TORQUE_CMD_REPORT_CRC);
}
//OWEND
