 ...
 */
static inline uint16_t mavlink_msg_esc_telemetry_5_to_8_pack_txbuf(char* mav_txbuf, mavlink_status_t* mav_status, uint8_t system_id, uint8_t component_id,
...
#else
    mavlink_esc_telemetry_5_to_8_t* packet = (mavlink_esc_telemetry_5_to_8_t*)(&mav_txbuf[header_len]);
