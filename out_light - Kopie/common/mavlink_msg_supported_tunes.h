...
//OW
/**
 * @brief Pack a supported_tunes message into a transmit buffer
 ...
 */
static inline uint16_t mavlink_msg_supported_tunes_pack_txbuf(char* mav_txbuf, mavlink_status_t* mav_status, uint8_t system_id, uint8_t component_id,
                                   uint8_t target_system, uint8_t target_component, uint32_t format)
{
...
#else
    mavlink_supported_tunes_t* packet = (mavlink_supported_tunes_t*)(&mav_txbuf[header_len]);
    ...
    return mavlink_finalize_message_txbuf(mav_txbuf, mav_status, system_id, component_id,
                                          MAVLINK_MSG_ID_SUPPORTED_TUNES, MAVLINK_MSG_ID_SUPPORTED_TUNES_MIN_LEN, MAVLINK_MSG_ID_SUPPORTED_TUNES_LEN, MAVLINK_MSG_ID_SUPPORTED_TUNES_CRC);
}
//OWEND
