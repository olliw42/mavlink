...
//OW
/**
 * @brief Pack a raw_rpm message into a transmit buffer
 ...
 */
static inline uint16_t mavlink_msg_raw_rpm_pack_txbuf(char* mav_txbuf, mavlink_status_t* mav_status, uint8_t system_id, uint8_t component_id,
                                   uint8_t index, float frequency)
{
...
#else
    mavlink_raw_rpm_t* packet = (mavlink_raw_rpm_t*)(&mav_txbuf[header_len]);
    ...
    return mavlink_finalize_message_txbuf(mav_txbuf, mav_status, system_id, component_id,
                                          MAVLINK_MSG_ID_RAW_RPM, MAVLINK_MSG_ID_RAW_RPM_MIN_LEN, MAVLINK_MSG_ID_RAW_RPM_LEN, MAVLINK_MSG_ID_RAW_RPM_CRC);
}
//OWEND
