...
/**
 * @brief Pack a statustext_long message into a transmit buffer
 ...
 */
static inline uint16_t mavlink_msg_statustext_long_pack_txbuf(char* mav_txbuf, mavlink_status_t* mav_status, uint8_t system_id, uint8_t component_id,
                                   uint8_t severity, const char *text)
{
...
#else
    mavlink_statustext_long_t* packet = (mavlink_statustext_long_t*)(&mav_txbuf[header_len]);
    ...
    return mavlink_finalize_message_txbuf(mav_txbuf, mav_status, system_id, component_id,
                                          MAVLINK_MSG_ID_STATUSTEXT_LONG, MAVLINK_MSG_ID_STATUSTEXT_LONG_MIN_LEN, MAVLINK_MSG_ID_STATUSTEXT_LONG_LEN, MAVLINK_MSG_ID_STATUSTEXT_LONG_CRC);
}
