 ...
 */
static inline uint16_t mavlink_msg_camera_trigger_pack_txbuf(char* mav_txbuf, mavlink_status_t* mav_status, uint8_t system_id, uint8_t component_id,
...
#else
    mavlink_camera_trigger_t* packet = (mavlink_camera_trigger_t*)(&mav_txbuf[header_len]);
